<template>
  <div class="empower">
    <div class="empower-wrap">
      <div class="wrap-form">
        <a-form-model ref="empower" :model="formData" :rules="formRule" :label-col="{span: 6}" :wrapper-col="{span: 16}">
          ...
          <a-form-model-item :wrapper-col="{offset: 6}">
            <a-button type="primary" :loading="submitLoad" @click="submitForm">Log in</a-button>
          </a-form-model-item>
        </a-form-model>
      </div>
    </div>
